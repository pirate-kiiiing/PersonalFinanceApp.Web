...
class StorageTools {
  ...
  public getPath(): string {
    if (this.hasPath() === false) {
      throw new pirateKingException('Path does not exist in storage');
    }
  ...
  public getUserSetting(): IUserSetting {
    if (this.hasUserSetting() === false) {
      throw new pirateKingException('User setting does not exist in storage');
    }
